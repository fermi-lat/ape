...
#Set include dirs to parent, to enable includes like
#include <readline/readline.h>
if(READLINE_FOUND)
  get_filename_component(READLINE_INCLUDE_DIRS
    ${Readline_INCLUDE_DIR} DIRECTORY)
endif()
...
if(READLINE_FOUND AND NOT TARGET Readline::Readline)
  ...
  target_include_directories(Readline::Readline INTERFACE
    "${READLINE_INCLUDE_DIRS}"
  )
